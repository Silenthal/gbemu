...
private static unsafe void hq4x_32_rb( uint * sp, uint srb, uint * dp, uint drb, int Xres, int Yres )
{
    int  i, j, k;
 ...
 public static unsafe void hq4x_32( uint * sp, uint * dp, int Xres, int Yres )
{
    uint rowBytesL = Xres * 4;
