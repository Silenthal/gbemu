...
namespace GBEmu.Emulator
{
    ...
    /// <summary>
    /// Transfers data to the appropriate OAM port in the video component.
    /// </summary>
    /// <param name="address">The OAM address to write to.</param>
    /// <param name="data">The data to write.</param>
    public delegate void DMATransferDelegate(byte address, byte data);
    ...
    class Video : TimedIODevice
    {
        ...
        private int ExecutedFrameCycles;
        ...
        {
            return 70224 - ExecutedFrameCycles;
        }
    }
}
